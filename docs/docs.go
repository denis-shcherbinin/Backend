            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.companyProfileResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "entity.Vacancy": {
            ...
            "properties": {
                "conditions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.VacancyCondition"
                    }
                },
                "description": {
                    "type": "string"
                ...
                "requirements": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.VacancyRequirement"
                    }
                },
                "responsibilities": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entity.VacancyResponsibility"
                    }
                },
                "skillLevel": {
                    "type": "string"
